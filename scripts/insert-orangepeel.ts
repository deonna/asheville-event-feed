/**
 * Insert Orange Peel events into database
 *
 * Scrapes events and inserts them into the database with proper
 * upsert logic (insert or update on URL conflict).
 *
 * Usage: npx tsx scripts/insert-orangepeel.ts
 */
...
async function main() {
  ...
  console.log('Inserting Orange Peel Events into Database');
  console.log('='.repeat(70));
  console.log();

  // Scrape events
  console.log('Scraping events...');
  const scrapedEvents = await scrapeOrangePeel();
